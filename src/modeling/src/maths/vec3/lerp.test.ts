...
test("vec3: lerp() called with three parameters should update a vec3 with correct values", () => {
	...
	const ret2 = lerp(obs2, [1, 2, 3], [5, 6, 7], 0.0);
	...
	const ret4 = lerp(obs4, [1, 2, 3], [5, 6, 7], 1.0);
