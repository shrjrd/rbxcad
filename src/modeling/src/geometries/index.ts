 ...
 */
export * as geom2 from "./geom2/index";
export * as geom3 from "./geom3/index";
export * as path2 from "./path2/index";
export * as poly2 from "./poly2/index";
export * as poly3 from "./poly3/index";
export * as slice from "./slice/index";
