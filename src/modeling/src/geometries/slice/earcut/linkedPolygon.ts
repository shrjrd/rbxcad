 ...
 */
export const linkedPolygon = (data: number[], start: number, _end: number, dim: number, clockwise: boolean) => {
 ...
 */
export const filterPoints = (start: Node, _end?: Node) => {
 ...
 */
export const cureLocalIntersections = (start: Node, triangles: number[], dim: number) => {
	let p = start;
	do {
		const a = p.prev;
		const b = p.next.next;
 ...
 */
export const locallyInside = (a: Node, b: Node) =>
 ...
 */
export const splitPolygon = (a: Node, b: Node) => {
 ...
 */
export const isValidDiagonal = (a: Node, b: Node) =>
	a.next.i !== b.i &&
	a.prev.i !== b.i &&
