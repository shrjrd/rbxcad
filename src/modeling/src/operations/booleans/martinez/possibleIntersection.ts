...
import { divideSegment } from "./divideSegment";
import { DIFFERENT_TRANSITION, NON_CONTRIBUTING, SAME_TRANSITION } from "./edgeType";
 ...
 */
export const possibleIntersection = (se1: SweepEvent, se2: SweepEvent, queue: Queue) => {
	...
	const nIntersections = inter ? inter.size() : 0;
