...
test("snap: snap of a path2 produces an expected path2", () => {
	...
	exp = [
		...
		[0.5106962954126519, 0.4285250731243595],
		[0.11576545177795361, 0.6565385020081387],
		[-0.33333333333333315, 0.5773502691896257],
		[-0.6264617471906055, 0.22801342888377923],
		[-0.6264617471906055, -0.2280134288837791],
		[-0.3333333333333336, -0.5773502691896256],
		[0.1157654517779533, -0.6565385020081387],
	...
	exp = [
		[1570.7979271820118, 0],
		[1203.3061290889411, 1009.6890116376164],
		[272.7710864950155, 1546.9412033856784],
		[-785.3989635910059, 1360.3552181729126],
		[-1476.0772155839566, 537.2521917480618],
		[-1476.0772155839566, -537.2521917480618],
		[-785.3989635910059, -1360.3552181729126],
		[272.7710864950155, -1546.9412033856784],
		[1203.3061290889411, -1009.6890116376164],
...
test("snap: snap of a geom2 produces an expected geom2", () => {
...
test("snap: snap of a geom3 produces an expected geom3", () => {
	...
	exp = [
		[
			[-1570.7963267948967, -1570.7963267948967, -1570.7963267948967],
			[-1570.7963267948967, -1570.7963267948967, 1570.7963267948967],
			[-1570.7963267948967, 1570.7963267948967, 1570.7963267948967],
			[-1570.7963267948967, 1570.7963267948967, -1570.7963267948967],
		],
